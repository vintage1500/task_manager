// README
// Единственное что меня смущает, насколько правильно объединить вывод завершенных и незавершенных задач в одну функцию или лучше было разделить на две отдельные функции с учетом одинакового наполнения функций
let tasks = [];
let completedTasks = [];
